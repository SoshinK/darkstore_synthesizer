...
class PositionIteratorPI(PositionIterator2D):
    def __init__(
        ...
        self.i = 0
        self.j = 0
        self.lst_of_pos = [(1.45 * WIDTH / 4, DEPTH / 3),
                        (1.45 * WIDTH / 4, 2 * DEPTH / 3),
                        (WIDTH / 2, 2 * DEPTH / 3),
                        (3 * WIDTH / 4 - 0.45 * WIDTH / 4, 2 * DEPTH / 3),
                        (3 * WIDTH / 4 - 0.45 * WIDTH / 4, DEPTH / 3)]
        self.counter = 0
...
if __name__ == "__main__":
    ...
    try_shelf_placement(room, is_rotate, data['random_shelfs'], args.show, args.pi)
